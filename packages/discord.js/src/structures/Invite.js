...
'use strict';
const { RouteBases, Routes, PermissionFlagsBits } = v10;
/**
...
class Invite extends Base {
    ...
    get deletable() {
        ...
        return Boolean(this.channel?.permissionsFor(this.client.user).has(PermissionFlagsBits.ManageChannels, false) ||
