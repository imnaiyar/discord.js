...
'use strict';
const { clearTimeout, setImmediate, setTimeout } = nodetimers;
const { GatewayDispatchEvents, GatewayIntentBits, OAuth2Scopes, Routes } = v10;
...
class Client extends BaseClient {
    ...
    async _checkReady() {
        ...
        this.readyTimeout = setTimeout(() => {
            this.emit(Events.Debug, `${hasGuildsIntent
