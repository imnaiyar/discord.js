...
const Messages = {
    ...
    [ErrorCodes.GlobalCommandPermissions]: 'Permissions for global commands may only be fetched or modified by providing a GuildResolvable ' +
    ...
    [ErrorCodes.PermissionOverwritesTypeMismatch]: expected => `"overwrite.id" is a ${expected.toLowerCase()} object, ` +
