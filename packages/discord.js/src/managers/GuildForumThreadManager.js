...
class GuildForumThreadManager extends ThreadManager {
     ...
     *   .catch(console.error);
     */
    async create({ name, autoArchiveDuration = this.channel.defaultAutoArchiveDuration, message, reason, rateLimitPerUser, appliedTags, } = {}) {
        if (!message) {
...
export { GuildForumThreadManager };
