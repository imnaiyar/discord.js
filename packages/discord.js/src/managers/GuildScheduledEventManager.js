...
'use strict';
const { GuildScheduledEventEntityType, Routes } = v10;
/**
...
class GuildScheduledEventManager extends CachedManager {
    ...
    async create(options) {
        ...
        let { privacyLevel, entityType, channel, name, scheduledStartTime, description, scheduledEndTime, entityMetadata, reason, image, recurrenceRule, } = options;
    ...
    async edit(guildScheduledEvent, options) {
        ...
        if (typeof options !== 'object')
            throw new DiscordjsTypeError(ErrorCodes.InvalidType, 'options', 'object', true);
        let { privacyLevel, entityType, channel, status, name, scheduledStartTime, description, scheduledEndTime, entityMetadata, reason, image, recurrenceRule, } = options;
        let entity_metadata;
        if (entityMetadata) {
            entity_metadata = {
