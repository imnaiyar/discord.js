...
class GuildChannelManager extends CachedManager {
    constructor(guild, iterable) {
        ...
        const defaultCaching = this._cache.constructor.name === 'Collection' ||
     ...
     * })
     */
    async create({ name, type, topic, nsfw, bitrate, userLimit, parent, permissionOverwrites, position, rateLimitPerUser, rtcRegion, videoQualityMode, defaultThreadRateLimitPerUser, availableTags, defaultReactionEmoji, defaultAutoArchiveDuration, defaultSortOrder, defaultForumLayout, reason, }) {
