...
To create an action row, use the <DocsLink section="builders" path="ActionRowBuilder:Class" /> class and the `ActionRowBuilder#addComponents` method to add buttons or a select menu.
